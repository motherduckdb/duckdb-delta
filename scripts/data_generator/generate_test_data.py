...
generate_test_data_pyspark(BASE_PATH,'simple_table_column_mapped', 'simple_table_column_mapped', base_query=base_query, queries=queries, mapping_mode='name')
...
generate_test_data_pyspark(BASE_PATH,'evolution_simple', 'evolution_simple', base_query=base_query, queries=queries)
...
generate_test_data_pyspark(BASE_PATH,'evolution_simple_name_mode', 'evolution_simple_name_mode', base_query=base_query, queries=queries, mapping_mode='name')
...
generate_test_data_pyspark(BASE_PATH,'evolution_column_change', 'evolution_column_change', base_query=base_query, queries=queries, mapping_mode='name')
...
generate_test_data_pyspark(BASE_PATH,'evolution_column_change_id_mode', 'evolution_column_change_id_mode', base_query=base_query, queries=queries, mapping_mode='id')
...
generate_test_data_pyspark(BASE_PATH,'evolution_type_widening', 'evolution_type_widening', base_query=base_query, queries=queries, mapping_mode='name')
...
generate_test_data_pyspark(BASE_PATH,'evolution_struct_field_modification', 'evolution_struct_field_modification', base_query=base_query, queries=queries, mapping_mode='name')
...
generate_test_data_pyspark(BASE_PATH,'evolution_struct_field_modification_nested', 'evolution_struct_field_modification_nested', base_query=base_query, queries=queries, mapping_mode='name')

################################################
### Domain metadata
################################################

## Table with domain metadata
generate_test_data_pyspark(
    BASE_PATH,
    'domain_metadata_table',
    'domain_metadata_table',
